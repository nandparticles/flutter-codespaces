    ...
    return Scaffold(
      ...
      body: ListView(children: [
        ...
        SwitchListTile(
          controlAffinity: ListTileControlAffinity.trailing,
          secondary: const Icon(Icons.switch_left_rounded),
          title: const Text("Native net for flutter (Need restart)"),
        ...
        SwitchListTile(
          controlAffinity: ListTileControlAffinity.trailing,
          secondary: const Icon(Icons.switch_left_rounded),
          title: const Text("Native net for java"),
          onChanged: (value) async {
        ...
        SwitchListTile(
          controlAffinity: ListTileControlAffinity.trailing,
          secondary: const Icon(Icons.switch_left_rounded),
          title: const Text("disable direct"),
          onChanged: (value) async {
        ...
        SwitchListTile(
          controlAffinity: ListTileControlAffinity.trailing,
          secondary: const Icon(Icons.switch_left_rounded),
          title: const Text("enable stopSocketV2"),
          onChanged: (value) async {
        ...
        const RepoUrlTile(),
        ListTile(
            title: const Text("clean ad mem"),
            leading: const Icon(Icons.cleaning_services_rounded),
            onTap: () {
              pipe.invokeMethod("CLEAN_AD_MEM_FOR_DEBUG");
            }),
        ListTile(
            title: const Text("req ad"),
        ...
        ListTile(
            title: const Text("clear premium"),
            leading: const Icon(Icons.send_rounded),
            onTap: () async {
              ref.read(purchaseDoneProvider.notifier).update(false);
        ...
        SwitchListTile(
          controlAffinity: ListTileControlAffinity.trailing,
          secondary: const Icon(Icons.switch_left_rounded),
          title: const Text("downscale image"),
        ...
        SwitchListTile(
          controlAffinity: ListTileControlAffinity.trailing,
          secondary: const Icon(Icons.switch_left_rounded),
          title: const Text("downscale page image"),
        ...
        SwitchListTile(
          controlAffinity: ListTileControlAffinity.trailing,
          secondary: const Icon(Icons.switch_left_rounded),
          title: const Text("auto refresh manga"),
        ...
        SwitchListTile(
          controlAffinity: ListTileControlAffinity.trailing,
          secondary: const Icon(Icons.switch_left_rounded),
          title: const Text("show direct flag"),
        ...
        SwitchListTile(
          controlAffinity: ListTileControlAffinity.trailing,
          secondary: const Icon(Icons.switch_left_rounded),
          title: const Text("show source url"),
